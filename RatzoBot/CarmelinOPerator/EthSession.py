...
class CapitalOP:
    ...
    def open_position(self, market_id, direction, size, level=None, stop_loss=None, take_profit=None, guaranteedStop=None):
        """
...
if __name__ == "__main__":
    try:
        ...
        capital_ops.set_account_id("260258040137462046")  # Cambia al ID de cuenta deseado
