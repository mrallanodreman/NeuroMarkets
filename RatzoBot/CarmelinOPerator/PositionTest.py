...
def open_test_position():
    ...
    try:
        ...
        market_id = "ETHUSD"  # Instrumento a negociar
        direction = "BUY"  # Dirección de la operación: "BUY" o "SELL"
        size = 0.01  # Tamaño de la posición
        stop_loss = 2450  # Stop Loss igual al tamaño de la posición (0.01)
        take_profit = 4000  # Nivel de Take Profit (opcional)
        guaranteed_stop = True  # Activamos el Stop Garantizado para evitar errores
        ...
        response = capital_ops.open_position(
            ...
            guaranteedStop=guaranteed_stop  # Ahora está en True
        )
